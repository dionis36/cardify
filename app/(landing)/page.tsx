  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-start py-12 px-4">
      ...
      <section className="text-center max-w-4xl mb-16">
        <h1 className="text-5xl font-extrabold mb-4">Cardify</h1>
        <p className="text-gray-700 text-lg mb-6">
          Design your perfect business cards online — fast, easy, and fully customizable.
        </p>
        <Link href="/templates">
          <Button className="px-6 py-3 text-lg">Browse Templates</Button>
        </Link>
      </section>
      ...
      <section className="text-center">
        <h2 className="text-3xl font-bold mb-4">Start Designing Your Card Today!</h2>
        <Link href="/templates">
          <Button className="px-8 py-4 text-lg">Start Now</Button>
        </Link>
      </section>
    </main>
  );
