  ...
  <div className="flex flex-col">
    ...
    <div className="relative flex items-center">
      <input
        ...
        className={`w-full border border-gray-300 p-2 pr-8 rounded-md text-sm transition-all focus:ring-blue-500 focus:border-blue-500 ${
...
const StyleButton: React.FC<StyleButtonProps> = ({ icon: Icon, active, onClick, title, disabled = false, className = '' }) => (
    <button
        ...
        title={title}
        disabled={disabled}
        className={`p-2 rounded transition-colors duration-150 flex items-center justify-center text-gray-600 ${
            active 
...
export default function PropertyPanel({
  ...
  // UPDATED: Include all new shape properties in the key union type for KonvaProps
  type AllKonvaPropKeys = keyof TextProps | keyof RectProps | keyof ImageProps | keyof CircleProps | keyof EllipseProps | keyof StarProps | keyof RegularPolygonProps | keyof LineProps | keyof ArrowProps | keyof PathProps;
    ...
    <div key="config" className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
            ...
            className={`p-2 rounded-md text-sm font-medium transition-colors flex flex-col items-center justify-center gap-1 ${
                isLocked ? 'bg-red-50 text-red-600 hover:bg-red-100' : 'bg-green-50 text-green-600 hover:bg-green-100'
            }`}
        ...
        <button
          ...
          className={`p-2 rounded-md text-sm font-medium transition-colors flex flex-col items-center justify-center gap-1 ${
              isVisible ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-yellow-50 text-yellow-600 hover:bg-yellow-100'
          }`}
        ...
        <button
          ...
          className={`p-2 rounded-md text-sm font-medium transition-colors flex flex-col items-center justify-center gap-1 ${
              node.editable ? 'bg-blue-50 text-blue-600 hover:bg-blue-100' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
  ...
  // 4. Shape & Border Properties (Consolidated for all shapes) - MOVED UP
